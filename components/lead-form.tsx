...
export function LeadForm({ type, title, intro, showPoints = false }: LeadFormProps) {
  ...
  return (
    <section className="mx-auto w-full max-w-3xl px-4 py-28 sm:px-6 lg:px-8">
      ...
      <form onSubmit={submit} className="mt-10 grid gap-4">
        ...
        <button
          ...
          className="focus-ring mt-2 inline-flex min-h-12 items-center justify-center gap-2 rounded-sm bg-ivory px-5 py-3 text-sm font-semibold text-ink transition hover:bg-white disabled:cursor-wait disabled:opacity-70"
        >
